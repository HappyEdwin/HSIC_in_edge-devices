...
#(RuntimeError: The size of tensor a (121) must match the size of tensor b (81) at non-singleton dimension 1)
...
def loadData(name):
    ...
    if name == 'Pavia':
        ...
        data = sio.loadmat(os.path.join(data_path, 'data/Indian.mat'))['indian_pines_corrected']
        labels = sio.loadmat(os.path.join(data_path, 'data/Indian_gt.mat'))['indian_pines_gt'] 
...
def create_data_loader(X, y, patch_size, batch_size=32, dataset="Pavia"):
...
if __name__ == '__main__':
    ...
    torch.save(net.state_dict(), f'params/{dataset}.pth')
